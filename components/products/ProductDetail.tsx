...
const SHARE_LABELS: Record<string, { share: string; shareBtn: string; copyAria: string; shareAria: string; copied: string; hint: string; more: string; igHint: string; shareTextPrefix: string }> = {
  ...
  'zh-CN': { share: '分享', shareBtn: '分享', copyAria: '复制链接', shareAria: '分享', copied: '已复制!', hint: 'Instagram、KakaoTalk、微信、Messenger 等可通过“分享”按鈕（移动端）选择。', more: '更多', igHint: '已复制链接 — 粘贴到 Instagram 分享。', shareTextPrefix: 'Mystic Lab 上的' },
