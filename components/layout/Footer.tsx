      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-sm text-[#9CA3AF] leading-relaxed mb-5 max-w-xs">{t("tagline")}</p>
          ...
          {/* Explore */}
          <div>
            <p className="text-xs font-semibold text-[#F0E6FF] uppercase tracking-widest mb-4">
              {t("sectionExplore")}
            </p>
        ...
        <div className="mt-10 pt-8 border-t border-[#2D2D4E]">
